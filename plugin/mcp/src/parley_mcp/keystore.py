...
- PARLEY_AGENT_SK_HEX  — 32-byte hex secret key
- PARLEY_AGENT_PK_HEX  — 32-byte hex public key
"""
...
def load_active_keypair() -> tuple[bytes, bytes]:
    ...
    sk_hex = os.environ.get("PARLEY_AGENT_SK_HEX")
    pk_hex = os.environ.get("PARLEY_AGENT_PK_HEX")
    ...
    if not agent_id:
        raise FileNotFoundError(
            ...
            "PARLEY_AGENT_SK_HEX/PK_HEX env vars set"
        )
