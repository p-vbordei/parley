...
Run via:
    uv run --directory plugin/mcp python -m parley_mcp.server

Configuration via env:
    PARLEY_BACKEND_URL    — default http://localhost:8000
    PARLEY_AGENT_SK_HEX   — override key file (testing)
    PARLEY_AGENT_PK_HEX   — override key file (testing)
"""
